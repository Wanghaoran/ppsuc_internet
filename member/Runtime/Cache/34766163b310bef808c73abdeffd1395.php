...
<div class="clear"></div>
    ...
    <div class="sb_box br-bg">
	    <h3 class="title">
			<div class="position">当前位置：<a title="首页" href="__ROOT__">首页</a> &gt; <a href="#">课程服务</a></div>
			<span>课程服务</span>
		</h3>
		<div class="clear"></div>
...
<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><li style="width: 223px; margin-left: 10px; margin-right: 10px; height: 165px;" class="list">
<a class="img" target="_self" title="<?php echo ($r["name"]); ?>" href="__ROOT__/member.php/index/course/id/<?php echo ($r["id"]); ?>"><img width="221" height="130" title="<?php echo ($r["name"]); ?>" alt="<?php echo ($r["name"]); ?>" src="__UPLOAD__/<?php echo ($r["pic"]); ?>"></a>
<h3><a target="_self" title="<?php echo ($r["name"]); ?>" href="__ROOT__/member.php/index/course/id/<?php echo ($r["id"]); ?>"><?php echo ($r["name"]); ?></a></h3>
