...
<div class="sidebar inner">
    <div class="sb_nav">
            ...
            <div class="ti1-bg"><span>学员中心</span></div>
			<h3 class="title1"></h3>
...
<div class="clear"></div>
    ...
    <div class="sb_box br-bg" style="height:350px;">
	    <h3 class="title">
			<div class="position">当前位置：<a title="首页" href="__ROOT__">首页</a> &gt; <a href="#">学员中心</a></div>
			<span>学员中心</span>
		</h3>
		<div class="clear"></div>

        <div id="showtext" class="editor active">
	<h3>尊敬的 <?php echo (session('member_name')); ?> 欢迎回到学员中心</h3>
